...
Poiché $\frac{30}{7} \approx 4.28$, una scelta di $c = 5$ soddisfa la condizione per qualunque $n_0 \ge 1$. Possiamo quindi concludere che $T(n) = \mathcal{O}(n)$.
...
Una scelta di $d = 1$ soddisfa la condizione per qualunque $n_0 \ge 1$. Possiamo quindi concludere che $T(n) = \Omega(n)$.
