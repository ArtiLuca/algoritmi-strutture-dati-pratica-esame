...
$$ P(i) = \text{"da } i \text{ in poi tutti i valori sono positivi"} $$
...
Se $V[q] < 0$, allora nessun indice $i \le q$ può essere stabile, perché scegliendo
...
Quindi nessun indice $i \le q$ può essere stabile, perché da $i$ in poi sarebbe
