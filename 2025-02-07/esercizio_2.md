...
Poiché le attività sono ordinate per tempo di inizio crescente:
...
2. Considera $a_5$.
   ...
   Quindi $a_5$ non è compatibile con $a_6$ e non viene scelta.
