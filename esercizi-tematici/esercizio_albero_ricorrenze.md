...
Prima dimostriamo che $T(n) = O(n^3)$, ovvero che $\exists c > 0, \exists n_0$ tali che $T(n) \le c n^3$ per ogni $n \ge n_0$.
...
$$
Una scelta di $c = 2$ e $n_0 \ge 1$ soddisfa la condizione, dimostrando che $T(n) = O(n^3)$.
