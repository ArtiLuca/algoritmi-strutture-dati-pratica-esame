...
| Esercizio 20 | Shortest Common Supersequence (SCS) | [Da completare](esercizio_20.md) |
| Esercizio 21 | Resto con numero minimo di banconote | [Da completare](esercizio_21.md) |
| Esercizio 22 | Cammino di costo minimo in una griglia | [Da completare](esercizio_22.md) |
...
* i. indicato con $l_j$ la somma massima di un sottoarray di $A[1..n]$ che termini con $A[j]$ (quindi del tipo $A[i..j]$), darne una caratterizzazione ricorsiva;
