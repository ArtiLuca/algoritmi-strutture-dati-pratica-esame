...
$s_1\le s_2\le\cdots\le s_n$, l'attività che inizia per ultima è $a_n$.
...
di quest'ultima, cioè se $f_m \le s_{last}$.
...
2. Considera $a_5$.
   ...
   Poiché $f_5=11>10=s_6$, l'attività $a_5$ non è compatibile con $a_6$ e non
   viene scelta.
...
tempo di inizio crescente, possiamo prendere $a_m=a_n$.

Sia $A^*$ una soluzione ottima, cioè un insieme di cardinalità massima di
attività mutuamente compatibili.

Se $A^*$ contiene già $a_m$, allora la proprietà è dimostrata.

Supponiamo invece che $A^*$ non contenga $a_m$.

Sia $a_k$ l'attività di $A^*$ che inizia più tardi tra tutte le attività
contenute in $A^*$. Poiché $a_m$ è l'attività che inizia più tardi tra tutte le
attività dell'input, vale $s_k \le s_m$.

Consideriamo ora una qualsiasi altra attività $a_i\in A^*$, con $a_i\ne a_k$.

Poiché $a_k$ è l'attività che inizia più tardi in $A^*$ e le attività di $A^*$
sono compatibili, l'attività $a_i$ deve terminare non oltre l'inizio di $a_k$,
cioè $f_i \le s_k$.

Dato che $s_k\le s_m$, otteniamo $f_i \le s_m$.

Quindi ogni attività di $A^*$ diversa da $a_k$ è compatibile anche con $a_m$.

Possiamo allora costruire il nuovo insieme:

$A' = A^* \setminus \{a_k\} \cup \{a_m\}$.

L'insieme $A'$ è ancora formato da attività mutuamente compatibili, ha la stessa
cardinalità di $A^*$ e contiene $a_m$.

Poiché $A^*$ era ottima e $|A'|=|A^*|$, anche $A'$ è ottima.
